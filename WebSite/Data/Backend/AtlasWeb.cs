...
{
	public class AtlasWeb
	{
		private readonly IAtlasWeb dal = DataAccess.CreateAtlasWeb();

		 private string ConnStr = "";

		 public AtlasWeb(string _ConnStr)
		 {
			 ConnStr = _ConnStr;
		 }
		...
		/// 获取一个对象实体
		/// </summary>
		public MAtlasWeb GetModel(int ID)
		{
		...
		/// 获取所有数据列表
		/// </summary>
		public List<MAtlasWeb> GetModelListAll()
		{
		...
		/// 根据网站编号获取数据
		/// </summary>
		public List<MAtlasWeb> GetModelListByWID(int WID)
		{ 
			string strWhere="";
			if (WID > 0)
